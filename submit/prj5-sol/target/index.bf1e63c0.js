...
function setupLoadFormHandler() {
    const errors = new _utilsJs.Errors();
    ...
    ssForm.addEventListener("submit", async (ev)=>{
        ...
        if (wsUrl.length === 0 || ssName.length === 0) {
            ...
            await (0, _spreadsheetJsDefault.default)({
                ws,
                ssName
            });
        }
...
*/ function makeTopLevelUI(wsUrl) {
    function makeLoadForm(wsUrl) {
        const form = _utilsJs.makeElement("form", {
            class: "form",
            id: "ss-form"
        });
        form.append(_utilsJs.makeElement("label", {
            for: "ws-url"
        }, "Web Services URL"));
        form.append(_utilsJs.makeElement("input", {
            name: "ws-url",
            id: "ws-url",
            value: wsUrl
        }));
        ...
        form.append(_utilsJs.makeElement("label"));
        form.append(_utilsJs.makeElement("button", {
            type: "submit"
        }, "Load Spreadsheet"));
        return form;
    }
    ...
    app.append(_utilsJs.makeElement("ul", {
        class: "error",
        id: "errors"
    }));
    //spreadsheet table should be rendered within this div
    app.append(_utilsJs.makeElement("div", {
        id: "ss"
    }));
}
 ...
 */ async function doFetchJson(method, url, jsonBody) {
    //TODO
    return (0, _cs544JsUtils.okResult)("TODO");
}

},{"cs544-js-utils":"8WQYV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ZFep":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$78bc = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$78bc.prelude(module);
...
const Spreadsheet = ({ ws, ssName })=>{
    _s();
    const [spreadsheetData, setSpreadsheetData] = (0, _react.useState)({});
    const [focusedCellId, setFocusedCellId] = (0, _react.useState)(null);
    const copyCellIdRef = (0, _react.useRef)(null);
    (0, _react.useEffect)(()=>{
        loadSpreadsheetData();
    }, []);
    ...
    const handleClearSpreadsheet = async (ev)=>{
        ...
        if (clearResult.isOk) setSpreadsheetData({});
    };
    const makeEmptySS = ()=>{
        const rows = [];
        const headerCells = /*#__PURE__*/ (0, _reactDefault.default).createElement("th", {
            key: "clear"
        ...
        rows.push(/*#__PURE__*/ (0, _reactDefault.default).createElement("tr", {
            key: "header-row"
        }, headerCells));
        ...
        return /*#__PURE__*/ (0, _reactDefault.default).createElement("table", null, /*#__PURE__*/ (0, _reactDefault.default).createElement("tbody", null, rows));
    };
    return /*#__PURE__*/ (0, _reactDefault.default).createElement("div", {
        id: "ss"
    }, makeEmptySS());
};
_s(Spreadsheet, "yUJzDv8dB0k2CQltTtxA8NXiR+Y=");
_c = Spreadsheet;
exports.default = Spreadsheet;
var _c;
$RefreshReg$(_c, "Spreadsheet");

  $parcel$ReactRefreshHelpers$78bc.postlude(module);
} finally {
...
},{"7422ead32dcc1e6b":"786KC"}]},["5uw0q","1xC6H","CnCET"], "CnCET", "parcelRequire94c2")
